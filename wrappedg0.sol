...
contract WrappedVG0 is ERC20, ReentrancyGuard {
    ...
    address public kittyCoreAddress = 0x16baF0dE678E52367adC69fD067E5eDd1D33e3bF;
    KittyCore kittyCore;
    ...
    function depositKittiesAndMintTokens(uint256[] calldata _kittyIds) external nonReentrant {
        ...
        for(uint i = 0; i < _kittyIds.length; i++){
            ...
            (a,a,kittyCooldown,a,a,a,a,a,kittyGen,a) = kittyCore.getKitty(kittyToDeposit);
...
contract KittyCore {
    ...
    function getKitty(uint256 _id) public view returns (uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256 _generation,uint256);
